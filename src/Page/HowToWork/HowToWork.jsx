...
export default function HowItWorks() {
  return (
    <div className="bg-gradient-to-tr from-primary/4 to-white py-4">
    <div className="w-11/12  mx-auto">
      ...
      <div className="relative border-l-2 border-dashed border-primary ml-4 sm:ml-0 sm:border-l-0 sm:before:absolute sm:before:left-1/2 sm:before:top-0 sm:before:bottom-0 sm:before:border-l-2 sm:before:border-dashed sm:before:border-primary">
        {steps.map((step, index) => (
          <div
            key={index}
            className={`mb-8 sm:flex sm:items-center sm:justify-between sm:relative ${
          ...
          >
            ...
            <div className="absolute left-[-12px] sm:left-1/2 sm:-translate-x-1/2 w-6 h-6 bg-primary rounded-full z-10 border-4 border-white shadow"></div>
